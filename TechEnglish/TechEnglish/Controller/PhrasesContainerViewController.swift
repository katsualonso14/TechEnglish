...
class PhrasesContainerViewController: UIViewController {

    private let segmentedControl: UISegmentedControl = {
        let control = UISegmentedControl(items: [
            NSLocalizedString("wordseeds_tab_button", comment: ""),
            NSLocalizedString("custom_word_list_tab_button", comment: "")
        ])
    ...
    private lazy var viewControllers: [UIViewController] = [
        WordSeedViewController(),
        CustomWordsViewController()
    ]
...
extension PhrasesContainerViewController: UIPageViewControllerDataSource, UIPageViewControllerDelegate {
